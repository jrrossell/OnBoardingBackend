...
public class ConfigMovies {
	...
	public CommandLineRunner iniciarDatos(MoviesRepository repository, ActorsRepository repositoryActors) {
		return args -> {
			...
			Actors actor1 = new Actors(1, "Junior");
			Actors actor2 = new Actors(2, "Actorcito");
			ArrayList<Actors> actores = new ArrayList<Actors>();
			
			actores.add(actor1);
			actores.add(actor2);
			
			repository.save(new Movies(1, "Capitan America", "Accion", "2010", actores.toString() ));
